<%-- 
    Document   : agregarServicioHotel
    Created on : 03-abr-2019, 23:04:48
    Author     : Carlos
--%>
    ...
    <body>
        ...
        <div class="container area">
            <div class="col-md-12">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="alert alert-danger alert-dismissible">
                                            ...
                                            El <b>nombre</b> del servicio ya existe.
                                        </div>
                                    </div>
                                </div>                            
                            </c:when>
                ...
                <div class="container">
                    <form id="formServicio" action="agregarServicioHotel/" method="POST" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label for="nombre" class="col-sm-2 col-form-label">Nombre servicio:</label>
                            <div class="col-sm-10">
                                <input maxlength="100" type="text" class="form-control" id="inputNombre" placeholder="Nombre del servicio..." name="nombre" required>
                            </div>
                        </div>
                        <div class="form-group row ">
                        ...
                        <div class="form-group row">
                            <label for="imagenDestacada" class="col-sm-2 col-form-label">Seleccionar imagen destacada:</label>
                            <div class="col-sm-10">
                                <input type="file" name="imagenDestacada" id="form-control-file" id="formControlFile" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="imagen1" class="col-sm-2 col-form-label">Seleccionar imagen:</label>
                            <div class="col-sm-10">
                                <input type="file" name="imagen1" id="form-control-file" id="formControlFile" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="imagen2" class="col-sm-2 col-form-label">Seleccionar imagen:</label>
                            <div class="col-sm-10">
                                <input type="file" name="imagen2" id="form-control-file" id="formControlFile" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="imagen3" class="col-sm-2 col-form-label">Seleccionar imagen:</label>
                            <div class="col-sm-10">
                                <input type="file" name="imagen3" id="form-control-file" id="formControlFile" required>
                            </div>
                        </div>
                        <br>
                        <div class="form-group row">
