    ...
    <body>
        ...
        <div class="container area">
            <div class="col-md-12">
                ...
                <div class="container">
                    <form id="formExperiencia" action="../actualizar/${experiencia.id}" method="POST" enctype="multipart/form-data">

                        <div class="form-group row">
                            <label for="nombre" class="col-sm-2 col-form-label">Nombre experiencia:</label>
                            <div class="col-sm-10">
                                <input maxlength="100" type="text" class="form-control" placeholder="nombre" name="nombre" value="${experiencia.nombre}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-5">
                                <fmt:parseDate value="${experiencia.fecha_inicio}" pattern="yyyy-MM-dd" var="parsedDate" type="date"/>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  id="time_element1" name="hora_inicio" value="${experiencia.hora_inicio}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <fmt:parseDate value="${experiencia.fecha_fin}" pattern="yyyy-MM-dd" var="parsedDate" type="date"/>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="time_element2" name="hora_fin" value="${experiencia.hora_fin}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="descripcion" class="col-sm-2 col-form-label">Descripción:</label>
                            <div class="col-sm-10">
                                <textarea maxlength="250" class="form-control" rows="4" placeholder="descripcion" name="descripcion" required>${experiencia.descripcion}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="precio" class="col-sm-2 col-form-label">Precio:</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="precio" placeholder="€" value="${experiencia.precio}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="distancia" class="col-sm-2 col-form-label">Distancia:</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="distancia" placeholder="minutos" value="${experiencia.mins_distancia}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="mapa" class="col-sm-2 col-form-label">Selecciona mapa:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control-file" name="mapa" id="formControlFile" value='${experiencia.mapa}'/>
                            </div>
                        </div>
                                ...
                                <div class="form-check form-check-inline" required>
                                    <c:forEach items="${tipos}" var="tipo">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="tipo" value="${tipo.id}"
                                                   <c:set var="tipoExperiencia" value="${tipo.id}" scope="page" />
                                                   <c:forEach items="${experiencia.tipos}" var="t">
                                                       <c:set var="tExperiencia" value="${t.id}" scope="page" />
                                                       <c:choose>
                                                           <c:when test="${tExperiencia eq tipoExperiencia}">
                                                               checked
                                                           </c:when>
                                                       </c:choose>
                                                   </c:forEach>
