<%-- 
    Document   : servicio
    Created on : 30-mar-2019, 6:25:40
                                        ...
                                        <c:choose>
                                            <c:when test="${foto.logo==false}">
                                                <div class="columna foto">
                                                    <img id="img-${loop}" class="img" src="<spring:url value="/resources/img/${foto.foto}"/>" alt="${servicio.nombre}" style="width:100%">
                                                </div>
                                                <!-- Modal content-->
                                                <div id="modal-${loop}" class="modal">
                                                    <img class="modal-content" id="img-modal-${loop}">
                                                    <span id="close-${loop}" class="close">&times;</span>
                                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <c:choose>
                            <c:when test="${servicio.disponible==true}">
                                Disponible
                            </c:when>
                            <c:otherwise>
                                No disponible
