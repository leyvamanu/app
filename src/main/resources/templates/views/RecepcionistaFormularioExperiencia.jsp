...
<html>
    <head>
        ...
        <title>Formulario Experiencia Recepcionista</title>
        <!--CDN-->
    ...
    <body>
                ...
                <div class="container">
                    <form id="formExperiencia" action="agregarExperiencia/" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control datepicker_recep" name="fecha_inicio">
                            </div>
                            <label for="hora_inicio" class="col-sm-1 col-form-label">Hora:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  id="time_elementrecep1" name="hora_inicio">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fecha_fin" class="col-sm-2 col-form-label">Fin:</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control datepicker_recep" name="fecha_fin">
                            </div>
                            <label for="hora_fin" class="col-sm-1 col-form-label">Hora:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="time_elementrecep2" name="hora_fin">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="descripcion" class="col-sm-2 col-form-label">Descripción:</label>
                            <div class="col-sm-10">
                                <textarea maxlength="250" class="form-control" rows="4" placeholder="descripcion" name="descripcion" required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
       ...
       <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
        ...
        <script type="text/javascript" src="/DiscoverMe/resources/js/fecha_hora_recepcionista.js"></script>
