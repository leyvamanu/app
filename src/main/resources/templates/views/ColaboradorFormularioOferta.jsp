    ...
    <body>
        ...
        <div class="container area">
            <div class="col-md-12">
                ...
                <div class="container">
                    <form id="formOferta" action="agregarOferta/" method="POST" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label for="rol" class="col-sm-2 col-form-label">Experiencia:</label>
                            <div class="col-sm-10">
                                <select name ="experiencia" form="formOferta" class="form-control">
