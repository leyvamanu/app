    ...
    <body>
        ...
        <div class="container area">
            <div class="col-md-12">
                ...
                <!--Cuerpo de la vista inicio Administrador-->
                <div class="container"><br>
                    <div class="row center-bloc">
                        <div class="col-md-4 center-block">
                            <a href="<spring:url value= '/administrador/listadoHuespedes/'/>"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/descargas.png" alt="Descargas"></a>
                            <h1 class="info">${apps}</h1>
                            <h4 class="info">App activas</h4>
                        </div>  
                        <div class="col-md-4 center-block">
                            <a href="<spring:url value= '/administrador/listadoComentarios/'/>"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/comentarios.png" alt="Comentarios"></a>
                            <h1 class="info">${comentarios}</h1>
                            <h4 class="info">Comentarios</h4>
                        </div>  
                        <div class="col-md-4 center-block">
                            <div class="center-block">
                                <a href="<spring:url value= '/administrador/listadoExperiencia/'/>"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/experiencia.png" alt="Experiencia"></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 center-block">
                            <a href="<spring:url value= '/administrador/listadoColaboradores/'/>"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/colaboracion.png" alt="Colaboracion"></a>
                            <h1 class="info">${colaboradores}</h1>
                            <h4 class="info">Colaboradores</h4>
                        </div>  
                        <div class="col-md-4 center-block">
                            <a href="<spring:url value= '/administrador/listadoServicio/'/>"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/hotel.png" alt="Hotel"></a>
                            <h1 class="info">${servicios}</h1>
                            <h4 class="info">Servicios</h4>
                        </div>  
                        <div class="col-md-4 center-block">
                            <a href="<spring:url value= '/administrador/listadoOfertas/'/>"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/oferta.png" alt="Oferta"></a>
