    ...
    <body>
                                    ...
                                    <c:choose>
                                        <c:when test="${usuario.id eq comentario.usuario.id}">
                                            <!--<div class="media-right">-->
                                                <form action="<spring:url value= '${comentario.id}/'/>">
                                                    <div class="editar media-bottom">
                                                    <input type="submit" class="btn btn-primary" value="Editar"/>
                                                    </div>
                                                </form>
                                                <form action="<spring:url value= 'eliminar/${comentario.id}/'/>">
        ...
        <c:choose>
            <c:when test="${comentado eq 'false'}">
                ...
                <div class="container">
                    <form action="<spring:url value= 'agregarComentario/'/>" method="POST">
