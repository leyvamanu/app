...
<html>
	...
	<link rel="icon" href="/DiscoverMe/resources/iconos/favicon.png" type="image/png" sizes="32x32">
        ...
        <!--CSS-->
        <link rel="stylesheet" type="text/css" href="/DiscoverMe/resources/css/estilos_preferencias.css">
    </head>
    <body>
        <!--Menú-->
        ...
        <!--Encuesta -->
        <div class="container"><br>
            <form action="<spring:url value= '/huesped/listadoExperiencia/'/>" method="POST">
                <c:forEach items="${preferencias}" var="preferencia">
                    <div class="row">
                        <div class="col-md-1 ">
                            <input id="${preferencia.id}" class="switch switch-rect-success" type="checkbox" name="preferencias" value="${preferencia.id}">
                            <label for="${preferencia.id}" class=""></label>
                        </div>
                        <div class="col-md-11">
                            <h4>
                                <small class="espacio">${preferencia.nombre}</small>
                            </h4>
                        </div>
                    </div>
                    <br>
