<%-- 
    Document   : ColaboradorAppsActivas
    Created on : 28-abr-2019, 0:14:12
    Author     : JoseLuis
--%>
...
<html>
    <head>
        ...
        <title>Apps activas por tipo de huésped</title>
        <!--CDN-->
                ...
                <div class="container"><br>
                    <div class="row">
                        <div class="col-md-12 center-bloc">
                            <h1>Cantidad de huéspedes por tipo de perfil</h1>
                            <hr/>
                        </div>
                    </div>
                </div>
                ...
                <div class="container"><br>
                    <div class="row center-bloc">
                        <div class="col-md-4 center-bloc">
                            <a href="#"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/Soltero.png"></button></a>
                            <h1 class="info">${soltero}</h1>
                            <br>
                            <h5 class="info">Soltero</h5>
                        </div>  
                        <div class="col-md-4 center-bloc">
                            <a href="#"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/Deluxe.png"></button></a>
                            <h1 class="info">${deluxe}</h1>
                            <br>
                            <h5 class="info">Deluxe</h5>
                        </div>
                        <div class="col-md-4 center-bloc">
                            <a href="#"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/Familiar.png"></button></a>
                            <h1 class="info">${familiar}</h1>
                            <br>
                    ...
                    <div class="row">
                        <div class="col-md-4 center-bloc">
                            <div class="center-block">
                                <a href="#"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/Low_cost.png"></button></a>
                                <h1 class="info">${lowCost}</h1>
                                <br>
                                <h5 class="info">Low_cost</h5>
                            </div>
                        </div>  
                        <div class="col-md-4 center-bloc">
                            <a href="#"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/Aventurero.png"></button></a>
                            <h1 class="info">${aventurero}</h1>
                            <br>
                            <h5 class="info">Aventurero</h5>
                        </div>
                        <div class="col-md-4 center-bloc">
                            <a href="#"><img class="thumbnail img-responsive" src="/DiscoverMe/resources/iconos/Mayor_de_50.png"></button></a>
                            <h1 class="info">${masCincuenta}</h1>
                            <br>
                            <h5 class="info">Mayores de 50</h5>
                        </div>    
                    </div>
                </div>
            </div>
